        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _db.db.none(_sql.user.update, [req.params.id, req.body.username, req.body.first_name, req.body.last_name, req.body.role, req.body.is_active]);

            case 3:
              return _context3.abrupt("return", res.status(200).json({
                status: 'OK',
                message: "User id: ".concat(req.params.id, " berhasil dirubah")
              }));
